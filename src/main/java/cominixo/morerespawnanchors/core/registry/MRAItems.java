...
public class MRAItems {
	...
	public static final RegistryObject<Item> NETHERITE_RESPAWN_ANCHOR = ITEMS.register("netherite_respawn_anchor", () -> new BlockItem(MRABlocks.NETHERITE_RESPAWN_ANCHOR.get(), new Item.Properties().group(ItemGroup.DECORATIONS).isImmuneToFire()));
	...
	public static final RegistryObject<Item> NETHERITE_END_RESPAWN_ANCHOR = ITEMS.register("netherite_end_respawn_anchor", () -> new BlockItem(MRABlocks.NETHERITE_END_RESPAWN_ANCHOR.get(), new Item.Properties().group(ItemGroup.DECORATIONS).isImmuneToFire()));
